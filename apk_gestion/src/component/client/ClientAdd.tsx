...
function ClientAdd() {
  ...
  const handleSubmit = async (e: { preventDefault: () => void; }) => {
    ...
    try {
      const response = await axios.post('http://localhost:3001/gestionDB/client/', formData);
      setFormData({
          nom: '',
          email: '',
          adresse: '',
      ...
      console.log('client inscrit avec succès:', response.data);
